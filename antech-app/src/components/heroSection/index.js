          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
            ...
            <div>
              <div className="mt-10">
                ...
                <a
                  href="#"
                  className="inline-block rounded-full border border-transparent bg-blue-600 text-lg hover:bg-purple-700 px-8 py-3 text-center font-medium text-white hover:bg--700"
                >
                  Learn more
                </a>
              </div>
